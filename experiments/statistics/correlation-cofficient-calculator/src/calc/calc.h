...
extern float* calc_correlation_cofficient_from_data(
    float* data1, size_t data1_size, float* data2, size_t data2_size,
    size_t data_size, float* correlation_cofficient);
